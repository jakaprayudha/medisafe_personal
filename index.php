...
<head>
   ...
   <meta
      name="description"
      content="Klinik Management System">
               ...
               <form
                  ...
                  <div class="form-group">
                     ...
                     <div class="input-wrapper">
                        ...
                        <i
                           class="fa-solid fa-user input-icon"></i>
                  ...
                  <button
                     ...
                     <i
                        class="fa-solid fa-right-to-bracket button-icon"></i>
         ...
         if (forgotPassword) {
            ...
            forgotPassword.addEventListener(
               ...
               function(event) {
                  ...
                  alert(
                     'Silakan hubungi administrator sistem untuk melakukan reset password.'
                  );
